...
var libFiles = [
  ...
  'lib/tgi-store-redis.lib.js',
  'node_modules/tgi-core/dist/tgi.core.chunk.js',
  'lib/tgi-store-redis.source.js',
...
gulp.task('_buildLib', function () {
  return gulp.src(libFiles)
    .pipe(concat('tgi-store-redis.js'))
    .pipe(gulp.dest('dist'))
    .pipe(rename('tgi-store-redis.min.js'))
    .pipe(uglify())
    .pipe(gulp.dest('dist'));
});
...
gulp.task('_buildSpec', function () {
  return gulp.src(specFiles)
    .pipe(concat('tgi-store-redis.spec.js'))
    .pipe(gulp.dest('dist'));
});
