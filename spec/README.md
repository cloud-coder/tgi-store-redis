...
#### RedisStore
The RedisStore handles data storage via redis.
...
&nbsp;<b><i>objects created should be an instance of RedisStore:</i></b>
```javascript
...
```
<blockquote><strong>log: </strong>ConvenienceStore: 7-Eleven<br><strong>log: </strong>a RedisStore<br>returns <strong>ConvenienceStore: 7-Eleven</strong> as expected
</blockquote>
#### onConnect()
...
// Make sure store starts in known state.  Stores such as RedisStore will retain test values.
...
```
<blockquote><strong>log: </strong>Moe,Larry,Shemp<br><strong>log: </strong>2<br><strong>log: </strong>2<br><strong>log: </strong>a RedisStore RedisStore<br>returns <strong>true</strong> as expected
</blockquote>
...
```
<blockquote><strong>log: </strong>a RedisStore<br>returns <strong>true</strong> as expected
</blockquote>
## [&#9664;](#-redis)&nbsp;[&#8984;](#table-of-contents) &nbsp;Summary
